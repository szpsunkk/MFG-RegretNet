#!/usr/bin/env python3
"""
在隐私论文合成 bid 上训练 DM-RegretNet（标准 RegretNet，与 RegretNet 同架构、独立种子/文件名）。
供 RQ1 与 Vanilla RegretNet 并列对比；产出：result/dm_regretnet_privacy_<epoch>_checkpoint.pt
"""
import argparse
import os

parser = argparse.ArgumentParser()
parser.add_argument("--random-seed", type=int, default=43, help="与 train_regretnet_privacy 默认 42 区分")
...
parser.add_argument("--name", default="dm_regretnet_privacy")
